...
import 'package:flutter_clone_wasapp/json/chat_json.dart';
              ...
              Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                      prefixIcon:
                          Icon(LineIcons.search, color: blanco.withOpacity(0.3)),
                      border: InputBorder.none,
                      hintText: "Busqueda",
                      hintStyle: TextStyle(
                          color: blanco.withOpacity(0.3), fontSize: 17)),
                ),
              ),
              SizedBox(
                height: 25,
                    ...
                    child: Column(
                      children: [
                        Text(
                          ...
                          style: TextStyle(fontSize: 14, color: blanco),
                        ),
                        Text(
              ...
              Row(
                children: [
                  ...
                  Padding(
                    ...
                    child: Divider(color: blanco.withOpacity(0.3)),
                  ),
